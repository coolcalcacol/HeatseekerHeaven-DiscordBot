	...
	data: new SlashCommandBuilder()
		...
		.addSubcommand(subcommand => subcommand // mmr-settings
			...
			.addNumberOption(option => option // onesmultiplier
				...
				.setDescription('When Global MMR is calculated, the 1v1 MMR is multiplied by this value [DEFAULT = 0.2]'),
			)
			.addNumberOption(option => option // twosmultiplier
				.setName('twos-multiplier')
				.setDescription('When Global MMR is calculated, the 2v2 MMR is multiplied by this value [DEFAULT = 0.3]'),
			)
			.addNumberOption(option => option // threesmultiplier
				.setName('threes-multiplier')
				.setDescription('When Global MMR is calculated, the 3v3 MMR is multiplied by this value [DEFAULT = 0.5]'),
			)
		...
		.addSubcommand(subcommand => subcommand // set-region-roles
			...
			.addStringOption(option => option // region
				.setName('region')
				.setDescription('The region acronym (EU, US, USE, etc.)')
				.setRequired(true)
				.addChoice('EU', 'EU')
				.addChoice('US', 'US')
				.addChoice('USE', 'USE')
			...
			.addStringOption(option => option // region
				...
				.setDescription('The preferred region if this region is not available (EU, US, USE, etc.)')
				.setRequired(false),
			)
