...
module.exports = {
	...
	async execute(interaction) {
		...
		let response = (generalData.generalQueueSettings.pauseQueue) ? 'queuePaused' : await queueData.actions.addPlayerToQueue(interaction, lobby, null, queueSettingsData);
		let responseArgs = '';
		...
		case 'userIsBlacklisted': {
			await interaction.reply({
				content: 'You do not have permission to queue at this time since you have been blacklisted.',
				ephemeral: true,
			});
		} break;
		case 'inQueue': {
